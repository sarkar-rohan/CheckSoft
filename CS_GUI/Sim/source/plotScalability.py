...
with open('/mnt/cloudNAS2/rohan/CSGUI/GUI/src/Results/CSLatency.csv', 'r') as csvFile:
...
fig.savefig('/mnt/cloudNAS2/rohan/CSGUI/GUI/src/Results/plot_scalability.png')
#plt.show()
